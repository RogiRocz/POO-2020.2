            ...
            switch (op[0]) {
                ...
                case "add":
                    try {
                        ...
                        System.out.println("Insira o fone por completo");
                    } catch (Exception r) {
                        System.out.println("Outro erro desconhecido " + r);
                    }
                    break;
                case "rm":
                    String nameRemove = op[1];
                    if (!agenda.rmContact(nameRemove)) {
                ...
                case "rmFone":
                    try {
                        ...
                        System.err.println("fail: pessoa nao existe");
                    } catch (IndexOutOfBoundsException ei) {
                        System.err.println("fail: nao existe o indice do numero");
                    }
                    break;
                case "star":
